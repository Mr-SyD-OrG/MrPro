...
syd_channel = environ.get('SYD_CHANNEL', -1003496202907)
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '').split()]
auth_channel = environ.get('AUTH_CHANNEL', -1003469127200) #Channel / Group Id for force sub ( make sure bot is admin )
