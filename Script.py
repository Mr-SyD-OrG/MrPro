...
<blockquote>Oɴᴇ Oꜰ Tʜᴇ Wᴏʀʟᴅꜱ Cᴏᴏʟᴇꜱᴛ, Bɪɢɢᴇꜱᴛ Aɴᴅ Fɪɴᴇꜱᴛ DᴀᴛᴀBᴀꜱᴇ</blockquote></b>"""
    ...
    START_TXT = """<b>ʜᴇʏ {}🤘, {}\n\nɪ Δᴍ ᴛʜᴇ ᴍᴏꜱᴛ ᴘᴏᴡᴇʀꜰᴜʟ ᴀᴜᴛᴏ ꜰɪʟᴛᴇʀ ʙᴏᴛ 💬 ᴡɪᴛʜ ꜰʀɪᴇɴᴅʟʏ ꜰᴇᴀᴛᴜʀᴇꜱ ❄️.\n\n<blockquote>ᴍᴀɪɴᴛΔɪɴᴇᴅ ʙʏ <a href="https://t.me/Mod_Moviez_X">Mᴏᴅ ᴍᴏᴠɪeᴢ ˹x˼™ ᠰ𐂮</a>🍓 </blockquote></b>"""
...
ɴᴏᴛᴇ: ᴛʜɪꜱ ʙᴏᴛ ɴᴇᴠᴇʀ ꜱʜᴀʀᴇꜱ ꜰɪʟᴇꜱ.</b>"""
...
""" 
   # PLEASE DO NOT REMOVE ANY CREDITS ❤️‍🩹
    ...
    CAPTION = """ 📂 <i><a href="https://t.me/+Uqdj6CEYypVlNDA9">{file_name}</a>\n{sydaudcap}</i>\n"""
